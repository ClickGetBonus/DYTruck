...
class LongJourneyOrderVC: UITableViewController {
    ...
    @IBOutlet weak var normalSendButton: UIButton!
    @IBOutlet weak var specialSendButton: UIButton!
    var isSendSelectionNormal: Bool = true
    ...
    override func viewDidLoad() {
        ...
        self.normalSendButton.setTitleColor(kRGBColorFromHex(0xf6a224), for: .normal)
        self.normalSendButton.layer.borderColor = kRGBColorFromHex(0xf6a224).cgColor
        self.normalSendButton.layer.borderWidth = 1.0
        
        self.specialSendButton.setTitleColor(kRGBColorFromHex(0x333333), for: .normal)
        self.specialSendButton.layer.borderColor = kRGBColorFromHex(0x333333).cgColor
        self.specialSendButton.layer.borderWidth = 1.0
    }
    ...
    @IBAction func onNormalSendButton(_ sender: Any) {
        
        if !self.isSendSelectionNormal {
            self.normalSendButton.setTitleColor(kRGBColorFromHex(0xf6a224), for: .normal)
            self.normalSendButton.layer.borderColor = kRGBColorFromHex(0xf6a224).cgColor
            self.normalSendButton.layer.borderWidth = 1.0
            ...
            self.specialSendButton.layer.borderColor = kRGBColorFromHex(0x333333).cgColor
            self.specialSendButton.layer.borderWidth = 1.0
            self.isSendSelectionNormal = !self.isSendSelectionNormal
        }
    }
    
    
    @IBAction func onSpecialSendButton(_ sender: Any) {
        
        if self.isSendSelectionNormal {
            self.normalSendButton.setTitleColor(kRGBColorFromHex(0x333333), for: .normal)
            self.normalSendButton.layer.borderColor = kRGBColorFromHex(0x333333).cgColor
            self.normalSendButton.layer.borderWidth = 1.0
            
            self.specialSendButton.setTitleColor(kRGBColorFromHex(0xf6a224), for: .normal)
            self.specialSendButton.layer.borderColor = kRGBColorFromHex(0xf6a224).cgColor
            self.specialSendButton.layer.borderWidth = 1.0
            self.isSendSelectionNormal = !self.isSendSelectionNormal
        }
    }
